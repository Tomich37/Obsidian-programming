...
13. [[CMD ENTRYPOINT и RUN]] — сравнение назначения основных исполняемых инструкций.
14. [[Multi-stage build]] — сборка образа в несколько этапов для уменьшения его размера.
